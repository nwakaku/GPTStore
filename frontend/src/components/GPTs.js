  ...
  const gptItems = [
    {
      ...
      description:
        "GPT-1 is a powerful language model designed to assist users with natural language understanding and generation. It excels in various applications, including text completion, summarization, and.",
      price: "$100 per h",
    },
    {
      name: "Avax",
    ...
    },
    {
      ...
      description:
        "GPT-2 represents a more advanced iteration of the language model, boasting enhanced capabilities in natural language processing. With improved performance and understanding, it is well-suited.",
      price: "$150 per h",
    },
  ];
